/**
 * @fileoverview Escena de precarga de recursos del juego.
 * Carga todos los assets (sprites, sonidos, música, mapas) antes de iniciar el juego.
 * @module Scenes/PreloadScene
 */

/**
 * Espaciado vertical entre elementos (no usado en esta escena).
 * @constant {number}
 */
const B_SPACING = 100;
 ...
 * @description Escena responsable de cargar todos los recursos del juego.
 * Muestra una pantalla de carga mientras se cargan sprites, sonidos, mapas y otros assets.
 */
class PreloadScene extends Phaser.Scene {
    /**
     * Crea una instancia de la escena de precarga.
     */
    constructor() {
     ...
     * Incluye sprites de personajes, enemigos, items, tilesets, sonidos y música.
     */
    preload() {
        // Configurar la URL base para GitHub Pages o local
    ...
    // this.load.tilemapTiledJSON('water_ts', 'MapaDeTiled/Water.tsx')
        ...
        this.load.audio('Boss_Hades', 'sonidos/BGM/BossHades.mp3');
    ...
    /**
     * Crea todas las animaciones del juego a partir de los spritesheets cargados.
     */
    createAnimations() {
        // Animaciones de Hades
        this.anims.create({
            key: 'HadesAnim',
        ...
        this.anims.create({
            key: 'pilar_arena',
            frames: this.anims.generateFrameNumbers('pilar_arenaTiles', { start: 0, end: 16 }),
            frameRate: 20,
            repeat: -1
        });

        // Animaciones de impulsos (soles)
        this.anims.create({
            key: 'sunB_move',
        ...
        // Animaciones de Goomba (diferentes versiones)
        this.anims.create({
            key: 'gomb_walk',
        ...
        // Animaciones de Koopa (diferentes versiones)
        this.anims.create({
            key: 'Koopa_walk',
    ...
    /**
     * Muestra el botón de "Play Game" después de completar la carga.
     * Permite iniciar el juego cuando el jugador esté listo.
     */
    showPlayButton() {
        ...
        // Al hacer clic, iniciar el menú principal
    ...
    /**
     * Crea los elementos visuales de la pantalla de carga.
     * Muestra un fondo de estrellas animado y texto de carga.
     */
    create() {
     ...
     * Anima el fondo de estrellas moviéndolo diagonalmente.
     * @param {number} time - Tiempo total transcurrido
     * @param {number} delta - Tiempo desde el último frame
     */
    update(time, delta) {
        // Movimiento parallax del fondo de estrellas
        if (this.stars) {
